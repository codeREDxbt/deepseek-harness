...
export const zh = {
  ...
  'message.rewind': '回退至此消息',
  'message.rewindUnavailable': '轮次运行中无法回退',
...
export const en = {
  ...
  'message.rewind': 'Rewind to this message',
  'message.rewindUnavailable': 'Cannot rewind while a turn is running',
